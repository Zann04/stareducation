...
import 'package:stareducation/obj/teacher_object.dart';
...
List<CourseObject> courses = [
  ...
  CourseObject(
    ...
    description:
        'Learning core algorithms and data structures for efficient programming.',
    cost: 200.0,
  ...
  CourseObject(
    ...
    description:
        'An introduction to machine learning and building models with Python.',
    cost: 300.0,
